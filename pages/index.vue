<template>
    <div class="my-10">
        <div class="md:flex w-full">
            <div class="md:w-1/3">
                <svg xmlns="http://www.w3.org/2000/svg" id="ade8c9af-7e2e-4eda-b5c8-b06129257226" data-name="Layer 1"
                    ...
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" fill="#d0cde1"></path>
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" fill="#63b0ff"></path>
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" fill="#2f2e41"></path>
                    <path
                            d="M206.70221,674.19438h36.8414l90.78774-35.52564s64.47245-26.31528,59.20939,23.68376-14.47341,117.103-14.47341,117.103-28.94681-13.15764-44.736-9.21035-5.26306-80.26162-5.26306-80.26162-128.9449,61.84092-140.78678,53.94634-14.4734-63.15669-14.4734-63.15669Z"
                            transform="translate(-61.96814 -72.38605)" opacity="0.1"></path>
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" fill="#DFC9CC"></path>
                    <path
                            d="M264.74607,558.82036l44.58576,64.05921L413.2772,709.72s96.0508,22.368,82.89315,38.15717S402.75109,732.088,402.75109,732.088s-119.73455-86.84044-123.68184-93.41927S231.70174,570.249,231.70174,570.249Z"
                            transform="translate(-61.96814 -72.38605)" opacity="0.1"></path>
                    <path
                    ...
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" fill="#2f2e41"></path>
                    <polygon points="526.306 575.493 534.2 605.756 499.99 716.28 492.096 682.07 526.306 575.493"
                             fill="#f2f2f2"></polygon>
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" fill="#2f2e41"></path>
                    <polygon points="474.991 689.965 477.622 726.806 418.413 726.806 418.413 689.965 474.991 689.965"
                             opacity="0.1"></polygon>
                    <polygon
                    ...
                    <path
                            ...
                            transform="translate(-61.96814 -72.38605)" opacity="0.1"></path>
                    <circle cx="196.04888" cy="357.07618" r="59.20939" fill="#DFC9CC"></circle>
                    <path
                    ...
                    <path d="M1096.8978,225.42666H732.64912V149.20722H1096.8978ZM734.25374,223.822h361.03944v-73.0102H734.25374Z"
                          transform="translate(-61.96814 -72.38605)" fill="#3f3d56"></path>
                    <rect x="645.80936" y="92.06506" width="362.64407" height="74.61482" fill="#63b0ff"></rect>
                    <circle cx="416.56486" cy="15.24386" r="5.61624" fill="#63b0ff"></circle>
                    <circle cx="435.8203" cy="15.24386" r="5.61624" fill="#63b0ff"></circle>
                    <circle cx="455.07573" cy="15.24386" r="5.61624" fill="#63b0ff"></circle>
                    <path d="M1138.03186,512.05187H462.48693V72.38605h675.54493Zm-673.94031-1.60462h672.33569V73.99067H464.09155Z"
                          transform="translate(-61.96814 -72.38605)" fill="#3f3d56"></path>
                    ...
                    <path d="M1061.59617,372.24937H756.71841V354.59855h304.87776ZM758.323,370.64475h301.66852V356.20317H758.323Z"
                          transform="translate(-61.96814 -72.38605)" fill="#3f3d56"></path>
                    <path d="M1061.195,310.07035H941.65084V292.41953H1061.195Zm-117.93955-1.60462h116.33493V294.02415H943.25546Z"
                          transform="translate(-61.96814 -72.38605)" fill="#3f3d56"></path>
                    <path
            ...
            <div class="mt-12 md:mt-0 md:w-2/3 md:ml-12 md:px-4">
                <p>I'm Cory, a full-stack developer from Philadelphia.</p>
                <p class="mt-6">I've worked as a professional web developer for the past 5 years, and have been a
                    hobbyist for
        ...
        <div class="mt-6 md:mt-12 flex justify-center">
            <div class="max-w-2xl w-full">
                <p class="md:text-center">While I'm currently employed full-time, I'm more than happy to discuss any
                    projects on your mind.</p>
            </div>
        </div>
        <div class="mt-12">
            <div class="flex justify-center flex-wrap text-sm text-base">
                <span class="mt-2 bg-gray-200 rounded p-2 font-semibold">Business Logic</span>
                <span class="mt-2 ml-2 bg-gray-200 rounded p-2 font-semibold">Subscription or per-order billing</span>
                <span class="mt-2 ml-2 bg-gray-200 rounded p-2 font-semibold">Data Dashboards, Metrics, and Reports</span>
                <span class="mt-2 ml-2 bg-gray-200 rounded p-2 font-semibold">Role-based and Administrator Access</span>
                <span class="mt-2 ml-2 bg-gray-200 rounded p-2 font-semibold">Email Capability</span>
                <span class="mt-2 ml-2 bg-gray-200 rounded p-2 font-semibold">Mobile Compatible with PWA</span>
            </div>
        </div>
    </div>
</template>
